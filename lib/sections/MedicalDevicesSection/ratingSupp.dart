...
class RatingSupplier extends StatefulWidget {
  ...
  @override
  State<RatingSupplier> createState() => _RatingSupplier();
}

class _RatingSupplier extends State<RatingSupplier> {
  String userName = "";
              ...
              Expanded(
                child: StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<Reviews_Supplier> reviewsList = snapshot.data!.docs
                        .map((doc) => Reviews_Supplier.fromMap(
                        ...
                        if (widget.userEmail.isNotEmpty) {
                          ...
                          if (userDoc.docs.isNotEmpty) {
                            ...
                            FirebaseFirestore.instance
                              ...
                              'supplierId':
                                  widget.supplierId, // Save the supplier ID
                            });
